...
class WebsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create web" do
    assert_difference('Web.count') do
      post webs_url, params: { web: { description: @web.description, name: @web.name, url: @web.url } }
    end
  ...
  test "should update web" do
    patch web_url(@web), params: { web: { description: @web.description, name: @web.name, url: @web.url } }
